class InsightsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @insight.save
        format.html { redirect_to insight_url(@insight), notice: "Insight was successfully created." }
  ...
  def update
    respond_to do |format|
      if @insight.update(insight_params)
        format.html { redirect_to insight_url(@insight), notice: "Insight was successfully updated." }
  ...
  private
    ...
    def insight_params
      params.require(:insight).permit(:title, :text)
    end
end
